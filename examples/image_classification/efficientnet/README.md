...
**CLIKA SDK** example to compress `EfficientNet` model on `ImageNet` dataset.
...
```shell
# pwd: image_classification/efficientnet
python3 efficientnet_main.py --output_dir outputs --data {imagenette | ILSVRC/Data/CLS-LOC}
```
