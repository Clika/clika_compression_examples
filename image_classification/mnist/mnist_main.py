...
from clika_compression import PyTorchCompressionEngine, QATQuantizationSettings, DeploymentSettings_TensorRT_ONNX, \
    DeploymentSettings_TFLite, LayerQuantizationSettings
...
def main(config):
    ...
    ====================================================================================================================
    """
    get_train_loader = partial(get_loader, config.data, config.batch_size, config.workers, True)
    get_eval_loader = partial(get_loader, config.data, config.batch_size, config.workers, False)
