...
import torch
from torchvision.models import resnet18, resnet50, ResNet18_Weights, ResNet50_Weights, resnext50_32x4d, \
...
def main(config):
    ...
    optimizer = torch.optim.SGD(parameters, lr=config.lr, momentum=0.9, weight_decay=1e-4)
