...
def main(data_dir: str):
    ...
    iamge_dir = data_dir.joinpath("images").resolve()
    shutil.rmtree(path=str(iamge_dir))
    iamge_dir.mkdir()
    (data_dir / "train2017").rename(iamge_dir / "train2017")
    (data_dir / "test2017").rename(iamge_dir / "test2017")
    (data_dir / "val2017").rename(iamge_dir / "val2017")
